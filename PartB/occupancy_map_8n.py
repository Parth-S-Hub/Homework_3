import sys
sys.path.append('C:/Users/Parth Shinde/PycharmProjects/pythonProject/MAP')
from tkinter import *
import numpy
...
gmap = OccupancyGridMap.from_png('C:/Users/Parth Shinde/PycharmProjects/pythonProject/MAP/example_map_occupancy.png', 1)
click = 0
...
def plan(event):
    ...
    if click == 0:
        ...
        #path, path_px = a_star_occupancy(start_node, goal_node, copy.deepcopy(gmap), movement='8N')
            ...
            #plot_on_canvas(path_px, cv, color="yellow", width=9)
        #else:
